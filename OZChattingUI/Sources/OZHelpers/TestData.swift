...
public let testMessages = [
  ...
  OZMessage(deviceStatus: "Cindy called with Alice for 11minutes.", statusType: OZMessageDeviceType.call),
  OZMessage(false, mp3: "test.mp3"),
  OZMessage(deviceStatus: "Marco joined SID campaign.", statusType: OZMessageDeviceType.campaign),
  OZMessage(deviceStatus: "Watch off", statusType: OZMessageDeviceType.watchOff),
